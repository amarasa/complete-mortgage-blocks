    ...
    ">
                    <div class="card border-[1px] border-solid border-[#d8d8d8] <?php if ($card_corners) { ?>rounded-xl<?php } ?> mb-8 p-10">
                        ...
                        <?php if (!empty($card['cta_link'])): ?>
                            <a href="<?php echo esc_url($card['cta_link']['url']); ?>" class="cta-button font-bold text-secondary hover:text-primary duration-300 ease-in-out transition-all !no-underline" target="<?php echo esc_attr($card['cta_link']['target'] ?: '_self'); ?>">
