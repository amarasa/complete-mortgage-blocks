                    ...
                    <div class="flex flex-wrap gap-8 justify-center mb-12">
                        <?php while (have_rows('specializations')) : the_row(); ?>
                            ...
                            <?php if ($optional_link) { ?>
                                <a href="<?php echo $optional_link['url']; ?>" class="flex items-center w-full sm:w-[48%] md:w-[30%] lg:w-[23%] gap-2 justify-center !no-underline transition-all ease-in-out duration-300 hover:opacity-80">
                                    <span class="text-white text-2xl <?php echo get_sub_field('icon'); ?>"></span>
