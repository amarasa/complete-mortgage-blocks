                ...
                <div class="container">
                    <div class="flex flex-wrap gap-8 justify-center mb-12">
                        <?php while (have_rows('specializations')) : the_row(); ?>
                            <div class="flex items-center w-full sm:w-[48%] md:w-[30%] lg:w-[23%] gap-2">
                                <span><img src="<?php echo get_sub_field('svg_icon'); ?>" class="w-[20px] h-[20px]" alt="Specialization Icon"></span>
