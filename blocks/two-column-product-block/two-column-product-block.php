    ...
    <div class="container px-8">
        <div class="grid grid-cols-12 md:gap-x-16 items-center">
            ...
            <div class="col-span-12 md:col-span-6 lg:col-span-5 mb-4 md:mb-0 <?php echo esc_attr($other_column_position); ?>">
                ...
                <?php if ($cta_content): ?>
                    <div class="mb-8"><?php echo $cta_content; ?></div>
                <?php endif; ?>

                <?php if ($cta_button): ?>
                    <a href="<?php echo esc_url($cta_button['url']); ?>" class="button !no-underline !text-white" target="<?php echo esc_attr($cta_button['target'] ?: '_self'); ?>">
