...
<section class="apply-online cmt-block <?php echo esc_attr($classes); ?> <?php if ($overlap) { ?>-mt-20 z-90 relative<?php } ?>" <?php echo $id; ?> data-block-name="<?php echo $acfKey; ?>">
    <div class="sm:container bg-[#ededed] px-8 py-10 md:p-16 <?php if ($corners) { ?>sm:rounded-2xl<?php } ?>">
